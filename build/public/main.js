...
/******/ 	return __webpack_require__(__webpack_require__.s = "KAxA");
/******/ })
/************************************************************************/
/******/ ({
...
"use strict";
/* WEBPACK VAR INJECTION */(function(process) {const config = Object.freeze({
  app: {
...
function register(config) {
  ...
  if ( true && 'serviceWorker' in navigator) {
    ...
    if (publicUrl.origin !== window.location.origin) {
      console.log('Not same origin'); // Our service worker won't work if PUBLIC_URL is on a different origin
    ...
    window.addEventListener('load', () => {
      ...
      if (isLocalhost) {
        console.log('In localhost!'); // This is running on localhost. Let's check if a service worker still exists or not.
        ...
        console.log('Not localhost!'); // Is not localhost. Just register service worker
...
// EXTERNAL MODULE: ./src/client/scriptsjs/serviceWorker.js
var serviceWorker = __webpack_require__("JKB2");

// EXTERNAL MODULE: ./node_modules/isomorphic-style-loader/StyleContext.js
var StyleContext = __webpack_require__("3OsT");
var StyleContext_default = /*#__PURE__*/__webpack_require__.n(StyleContext);

// EXTERNAL MODULE: ./src/client/config.ts
var config = __webpack_require__("A9TN");

// EXTERNAL MODULE: ./node_modules/fast-memoize/src/index.js
var src = __webpack_require__("75pU");
...
const getNavigationBar = createSelector(state => state, state => ({
...
class Navbar_Navbar extends react_default.a.PureComponent {
  constructor(props) {
    super(props);
    ...
    Navbar_defineProperty(this, "render", () => {
      ...
      return react_default.a.createElement("header", properties, react_default.a.createElement("div", {
        ...
        href: "/"
      }, this.props.brandName))), react_default.a.createElement("ul", null, routes.map((element, idx) => react_default.a.createElement("li", {
        key: idx
      }, react_default.a.createElement(Link, src_default()(this.getLinkProps)(style, element, idx), element.label)))));
    });

    this.navbar = react_default.a.createRef();
  }

}

const Navbar_mapStateToProps = state => getNavigationBar(state.presentation);

/* harmony default export */ var navbar_Navbar = (connect_connect(Navbar_mapStateToProps, Dispatchers)(Navbar_Navbar));
...
class NavbarPadder_NavbarPadder extends react_default.a.PureComponent {
  constructor(...args) {
    super(...args);
...
class ContentSection_ContentSection extends react_default.a.PureComponent {
  constructor(props) {
    super(props);
...
class Wrapper_Wrapper extends react_default.a.PureComponent {
  constructor(...args) {
    super(...args);
    ...
    Wrapper_defineProperty(this, "render", () => {
      ...
      return react_default.a.createElement("div", props, children);
    });
  }
...
class ContentArea_ContentArea extends react_default.a.PureComponent {
  constructor(props) {
    super(props);
    ...
    ContentArea_defineProperty(this, "render", () => {
      ...
      }, react_default.a.createElement(Wrapper_Wrapper, {
        className: style.contentPadder
      }, react_default.a.createElement(content_ContentSection, {
        styling: style
      }), react_default.a.createElement(content_ContentSection, {
        styling: style
      }), react_default.a.createElement(content_ContentSection, {
...
class FooterArea_FooterArea extends react_default.a.Component {
  constructor(props) {
    super(props);
...
/* harmony default export */ var ripple_applier = ((event, style) => {
  jquery_default()(asClass(style.ripple)).remove();
  ...
  jquery_default()(asClass(style.ripple)).css({
    width: buttonWidth,
    height: buttonHeight,
    top: y,
    left: x
...
function SidebarToggle_extends() { SidebarToggle_extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return SidebarToggle_extends.apply(this, arguments); }
...
class SidebarToggle_SidebarToggle extends react_default.a.PureComponent {
  constructor(_props) {
    super(_props);
    ...
    SidebarToggle_defineProperty(this, "render", () => {
      ...
      return react_default.a.createElement("div", SidebarToggle_extends({
        className: react_utils_join(...toggleClasses)
      }, props), react_default.a.createElement("i", {
...
/* harmony default export */ var sidebar_SidebarToggle = (connect_connect(SidebarToggle_mapStateToProps, {
...
const version = '1.3.5';
class VersionInfo_VersionInfo extends react_default.a.PureComponent {
  constructor(props) {
    super(props);

    VersionInfo_defineProperty(this, "render", () => {
      return react_default.a.createElement("div", null, react_default.a.createElement("h2", null, "Api Name"), react_default.a.createElement("h5", null, "version: ", version));
    });
  }
...
class TopSection_TopSection extends react_default.a.PureComponent {
  constructor(props) {
    super(props);
    ...
    TopSection_defineProperty(this, "render", () => {
      ...
      }, react_default.a.createElement(VersionInfo_VersionInfo, {
        styling: style
      }), react_default.a.createElement(sidebar_SidebarToggle, {
        styling: style
      }));
    });
  }
...
class SidebarSubItem_SidebarSubItem extends react_default.a.PureComponent {
  constructor(props) {
    super(props);
    ...
    SidebarSubItem_defineProperty(this, "render", () => {
      ...
      }, method), react_default.a.createElement("a", {
        className: style.truncate,
        href: hash
      }, label)), react_default.a.createElement("i", {
...
class SidebarSubMenu_SidebarSubMenu extends react_default.a.PureComponent {
  constructor(props) {
    super(props);
    ...
    SidebarSubMenu_defineProperty(this, "render", () => {
      ...
      const listItems = links.map((x, index) => react_default.a.createElement(sidebar_SidebarSubItem, {
        key: index,
        hash: '#' + x,
        label: x.label,
        styling: style,
    ...
    this.menu = Object(react["createRef"])();
    this.state = {
      hidden: true,
      loaded: false,
      height: 0
...
class SidebarMenuItem_SidebarMenuItem extends react_default.a.PureComponent {
  constructor(props) {
    super(props);
    ...
    SidebarMenuItem_defineProperty(this, "render", () => {
      ...
      return react_default.a.createElement("li", {
        ...
        className: MaterialIcons.CLASS
      }, MaterialIcons.icons.CHEV_RIGHT), react_default.a.createElement(sidebar_SidebarSubMenu, {
        styling: style,
...
class MainSection_MainSection extends react_default.a.PureComponent {
  constructor(props) {
    super(props);

    MainSection_defineProperty(this, "render", () => {
      const style = this.props.styling;
      return react_default.a.createElement(react["Fragment"], null, react_default.a.createElement("h2", {
        className: style.menuHeader
      }, this.props.header), react_default.a.createElement("ul", {
        className: style.mainSection
      }, MainSection_routes.map((x, index) => react_default.a.createElement(sidebar_SidebarMenuItem, {
        key: index,
        styling: style,
        hash: `#${x}`,
        label: x
...
class MiddleSection_MiddleSection extends react_default.a.PureComponent {
  constructor(props) {
    super(props);
    ...
    MiddleSection_defineProperty(this, "render", () => {
      ...
      }, MiddleSection_links.map((x, index) => react_default.a.createElement(sidebar_SidebarMenuItem, {
        key: index,
        styling: style,
        hash: '#' + x,
        label: x
...
class SidebarSearch_SidebarSearch extends react_default.a.PureComponent {
  constructor(props) {
    super(props);
...
const getSidemenu = createSelector(state => state, state => ({
...
class SidebarMenu_SidebarMenu extends react_default.a.PureComponent {
  constructor(props) {
    super(props);
    ...
    SidebarMenu_defineProperty(this, "render", () => {
      ...
      return react_default.a.createElement("aside", SidebarMenu_extends({}, common, actions), react_default.a.createElement(TopSection_TopSection, {
        styling: style
      }), react_default.a.createElement(sidebar_SidebarSearch, {
        styling: style,
        menuState: this.state
      }), react_default.a.createElement(MiddleSection_MiddleSection, {
        styling: style,
        header: headers[0]
      }), react_default.a.createElement(MainSection_MainSection, {
        styling: style,
        header: headers[1]
      }));
    });
...
/* harmony default export */ var sidebar_SidebarMenu = (connect_connect(SidebarMenu_mapStateToProps, SidebarMenu_Dispatchers)(SidebarMenu_SidebarMenu));
...
class SandboxSection_SandboxSection extends react_default.a.PureComponent {
  constructor(props) {
    super(props);
...
const getSandbox = createSelector(state => state, state => ({
...
class SandboxArea_SandboxArea extends react_default.a.PureComponent {
  constructor(props) {
    super(props);
    ...
    SandboxArea_defineProperty(this, "render", () => {
      ...
      return react_default.a.createElement("aside", common, react_default.a.createElement(sandbox_SandboxSection, {
        styling: style
      }), react_default.a.createElement(sandbox_SandboxSection, {
        styling: style
      }));
    });
  }
...
/* harmony default export */ var sandbox_SandboxArea = (connect_connect(SandboxArea_mapStateToProps, SandboxArea_Dispatchers)(SandboxArea_SandboxArea));
...
class DocsPage_DocsPage extends react_default.a.Component {
  constructor(props) {
    super(props);
    ...
    DocsPage_defineProperty(this, "render", () => {
      const style = this.props.styling;
      return react_default.a.createElement(react["Fragment"], null, react_default.a.createElement(sidebar_SidebarMenu, {
        self: this.sidebar,
        styling: style
      }), react_default.a.createElement(sandbox_SandboxArea, {
        self: this.sandbox,
        styling: style
      }), react_default.a.createElement(content_ContentArea, {
        self: this.content,
        styling: style
      }), react_default.a.createElement(footer_FooterArea, {
        self: this.footer,
        styling: style
      }));
    });

    this.footer = Object(react["createRef"])();
    this.sidebar = Object(react["createRef"])();
    this.sandbox = Object(react["createRef"])();
    this.content = Object(react["createRef"])();
  }
...
/* harmony default export */ var documentation_DocsPage = (connect_connect(DocsPage_mapStateToProps, section_action_Dispatchers)(DocsPage_DocsPage));
...
class AboutPage_AboutPage extends react_default.a.PureComponent {
  constructor(...args) {
    super(...args);
...
class AdminPage_AdminPage extends react_default.a.PureComponent {
  constructor(...args) {
    super(...args);
...
class Lost_Lost extends react_default.a.PureComponent {
  constructor(...args) {
    super(...args);

    Lost_defineProperty(this, "render", () => {
      return react_default.a.createElement("h2", null, "404 Not Found");
    });
  }
...
/* harmony default export */ var Routes = (otherProps => [{ ...Routes_routes[0],
  render: props => react_default.a.createElement(documentation_DocsPage, Routes_extends({}, props, otherProps))
}, { ...Routes_routes[1],
  render: props => react_default.a.createElement(documentation_DocsPage, Routes_extends({}, props, otherProps))
}, { ...Routes_routes[2],
  render: props => react_default.a.createElement(information_AboutPage, Routes_extends({}, props, otherProps))
}, { ...Routes_routes[3],
  render: props => react_default.a.createElement(administration_AdminPage, Routes_extends({}, props, otherProps))
}, { ...Routes_routes[4],
  render: props => react_default.a.createElement(Lost_Lost, Routes_extends({}, props, otherProps))
}]);
...
class App_App extends react_default.a.PureComponent {
  constructor(props) {
    super(props);
    ...
    App_defineProperty(this, "render", () => {
      ...
      const routings = routes.map((route, idx) => react_default.a.createElement(react_router_Route, {
        exact: true,
        key: idx,
        path: route.path,
        render: route.render
      }));
      return react_default.a.createElement(react["Fragment"], null, react_default.a.createElement(NavbarPadder_NavbarPadder, {
        self: this.padder,
        styling: app_default.a
      }), react_default.a.createElement(react_router_Switch, null, " ", routings, " "), react_default.a.createElement(navbar_Navbar, {
        styling: app_default.a,
        location: this.props.location,
        brandName: config["a" /* default */].app.NAME,
        routings: elements
      }));
    });

    this.padder = react_default.a.createRef();
    this.state = {
      navPadding: 0
    };
  }
...
const client_initialState = window.__REDUX_STATE__ || {};
delete window.__REDUX_STATE__;
const client_store = configureStore(client_initialState);
...
}, react_default.a.createElement(StyleContext_default.a.Provider, {
  value: {
    insertCss
  }
...
Object(serviceWorker["a" /* register */])();
...
/***/ (function(module, exports, __webpack_require__) {
    ...
    var refs = 0;
    var css = __webpack_require__("q4DW");
    var insertCss = __webpack_require__("Q8e5");
