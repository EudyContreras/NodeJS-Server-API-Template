...
var path_to_regexp = __webpack_require__(21);
...
var StyleContext = __webpack_require__(19);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(18), __webpack_require__(45)(module)))
...
class Navbar_Navbar extends react_default.a.PureComponent {
  constructor(props) {
    ...
    _defineProperty(this, "handleLinkClick", (e, tab) => {
...
Navbar_Navbar.propTypes = {
  routings: prop_types_default.a.arrayOf(prop_types_default.a.any),
  activeTab: prop_types_default.a.any,
  brandName: prop_types_default.a.string
};
...
class ContentArea_ContentArea extends react_default.a.PureComponent {
  ...
  render() {
    ...
    }, react_default.a.createElement(content_ContentSection, null), react_default.a.createElement(content_ContentSection, null), react_default.a.createElement(content_ContentSection, null), react_default.a.createElement(content_ContentSection, null), react_default.a.createElement(content_ContentSection, null), react_default.a.createElement(content_ContentSection, null));
  }
...
class FooterArea_FooterArea extends react_default.a.PureComponent {
  render() {
...
class SidebarSubMenu_SidebarSubMenu extends react_default.a.PureComponent {
  render() {
    ...
    return react_default.a.createElement("ul", {
      className: "sub-menu"
    }, links.map(x => react_default.a.createElement(sidebar_SidebarSubItem, {
      hash: '#' + x,
      label: x.label,
...
class SidebarMenuItem_SidebarMenuItem extends react_default.a.PureComponent {
  render() {
    ...
    return react_default.a.createElement("div", null, react_default.a.createElement("li", {
      ...
      className: "material-icons"
    }, "chevron_right")), react_default.a.createElement(sidebar_SidebarSubMenu, null));
  }
...
class SidebarMenu_SidebarMenu extends react_default.a.PureComponent {
  render() {
    ...
    }, react_default.a.createElement("h2", null, "Api Name"), react_default.a.createElement("h5", null, "version: ", version)), react_default.a.createElement("div", {
      id: "sidebar-toggle",
      title: "expand",
      value: "",
      className: "expand"
    ...
    }, "chevron_right"))), react_default.a.createElement(sidebar_SidebarSearch, null), react_default.a.createElement("h2", {
      className: "menu-header"
    }, headers[0]), react_default.a.createElement("ul", {
      className: "middle-section"
    }, links.map(x => react_default.a.createElement(sidebar_SidebarMenuItem, {
      hash: '#' + x,
      label: x
    }))), react_default.a.createElement("h2", {
      className: "menu-header"
    }, headers[1]), react_default.a.createElement("ul", {
      className: "main-section"
    }, routes.map(x => react_default.a.createElement(sidebar_SidebarMenuItem, {
      hash: '#' + x,
      label: x
    }))));
  }
...
class SandboxArea_SandboxArea extends react_default.a.PureComponent {
  render() {
    ...
    }, react_default.a.createElement(sandbox_SandboxSection, null), react_default.a.createElement(sandbox_SandboxSection, null), react_default.a.createElement(sandbox_SandboxSection, null), react_default.a.createElement(sandbox_SandboxSection, null), react_default.a.createElement(sandbox_SandboxSection, null));
  }
...
class DocsPage_DocsPage extends react_default.a.PureComponent {
  render() {
    return react_default.a.createElement(common_Wrapper, null, react_default.a.createElement(sidebar_SidebarMenu, null), react_default.a.createElement(sandbox_SandboxArea, null), react_default.a.createElement(content_ContentArea, null), react_default.a.createElement(footer_FooterArea, null));
  }
...
class App_App extends react_default.a.PureComponent {
  render() {
    return react_default.a.createElement(common_Wrapper, {
      className: "App"
    }, react_default.a.createElement(navbar_NavbarPadder, null), react_default.a.createElement(react_router["c" /* Switch */], null, client_routes.map((route, idx) => react_default.a.createElement(react_router["a" /* Route */], _extends({
      exact: true,
      key: idx
    }, route)))), react_default.a.createElement(navbar_Navbar, {
...
/* harmony default export */ var components_App = __webpack_exports__["a"] = (withStyles_default()(app_default.a)(App_App));
...
function configureStore(initialState) {
  const middleWare = [es];
  const composeEnhancers = typeof window !== 'undefined' && window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ || redux["d" /* compose */];
  const store = Object(redux["e" /* createStore */])(reducers, initialState, composeEnhancers(Object(redux["a" /* applyMiddleware */])(...middleWare)));
  return store;
}
...
/* harmony import */ var isomorphic_style_loader_StyleContext__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(19);
...
/* harmony import */ var _client_components_App__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(31);
/* harmony import */ var _client_store__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(32);
/* harmony import */ var react_router_dom__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(14);
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(30);
...
const store = Object(_client_store__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"])(initialState);
...
react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.hydrate(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_redux__WEBPACK_IMPORTED_MODULE_6__[/* Provider */ "a"], {
  store: store
}, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_5__[/* BrowserRouter */ "a"], null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(isomorphic_style_loader_StyleContext__WEBPACK_IMPORTED_MODULE_2___default.a.Provider, {
  value: {
    insertCss
  }
}, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_client_components_App__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"], null)))), document.getElementById('content'));
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(18)))
...
*/
var aa=__webpack_require__(0),n=__webpack_require__(23),q=__webpack_require__(36);function u(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!aa)throw Error(u(227));var ba=null,ca={};
